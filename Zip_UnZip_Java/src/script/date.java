...
public class ZipIt_1 {
    ...
    public static void main(String[] args) throws IOException {
        String sourceFile = "A:\\ProgrammingJAR\\cloudera-quickstart-vm-5.4.2-0-virtualbox\\cloudera-quickstart-vm-5.4.2-0-virtualbox"; // source Path
        
        FileOutputStream fos = new FileOutputStream("A:\\ProgrammingJAR\\cloudera-quickstart-vm-5.4.2-0-virtualbox\\Compressed_Logs " + today() + ".zip"); // Target Path
    ...
    private static void delete(File fileToZip) {
